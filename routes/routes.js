...
router.get('/login/:id', middleware.sspi, routesController.login);
...
router.post('/captura', middleware.sspi, routesController.captura_POST);
router.post('/captura_embarque', middleware.sspi, routesController.captura_embarque_POST);
router.post('/guardar_captura', middleware.sspi, routesController.guardar_captura_POST);
...
router.post('/cerrar_embarque', middleware.sspi, routesController.cerrar_embarque_POST);
...
router.post('/getDelivery', middleware.sspi, routesController.getDelivery_POST);
router.post('/getTotalQty', middleware.sspi, routesController.getTotalQty_POST);
router.post('/getDeliveryInfo', middleware.sspi, routesController.getDeliveryInfo_POST);
router.post('/checksingle', middleware.sspi, routesController.checkSingle_POST);
